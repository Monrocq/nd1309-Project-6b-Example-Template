    ...
    ConsumerRole
{
    ...
    function processItem(uint256 _upc, uint256 _productID)
        public
        harvested(_upc)
    ...
    function buyItem(uint256 _upc, address _distributorID)
        public
        payable
        forSale(_upc)
        onlyDistributor
    ...
    function receiveItem(uint256 _upc, address _retailerID)
        public
        shipped(_upc)
        onlyRetailer
    {
    ...
    function purchaseItem(uint256 _upc, address _consumerID)
        public
        received(_upc)
        onlyConsumer
        checkValue(0)
